...
class PyramidSorting(SortingVisualisationA):
    ...
    def get_coordinates(self, value, index):
        ...
        x = (self.middle_of_screen_x - self.pixel_multiplicator) * math.cos(self.step * value) * display_percentage_of_radius + self.middle_of_screen_x + 1/10 * self.middle_of_screen_x
        y = (self.middle_of_screen_y - self.pixel_multiplicator) * display_percentage_of_radius + self.middle_of_screen_y 
        return [x,y]
