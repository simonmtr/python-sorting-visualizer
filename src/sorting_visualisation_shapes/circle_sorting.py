...
class CircleSorting:
    ...
    def get_x_and_y(self, array_to_sort, value):
        ...
        print(f"display_percentage_of_radius for {value} is {display_percentage_of_radius} because it is at index ")
    ...
    def get_display_percentage_of_radius(self, array_to_sort, value):
        ...
        return (abs(value-index_in_sorting_array))/worst_case_index_difference
